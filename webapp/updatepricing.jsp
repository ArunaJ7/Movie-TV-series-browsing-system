...
<body>
	...
	<div class="content">
		<form name="formContact" action="updatex" method="POST">
		  <div class="user-box">
			<p class="login-text" style="font-size: 2rem; font-weight: 800;">Update Your Chooses</p>
			...
			<div class="input-group">
			  <label>Year</label>
			  <input type= "text" name="genres" value="<%= genres %>"><br>
	
			</div>
			<div class="input-group">
			  <label>HD Available</label>
			<input type= "text" name="hdAvailable" value="<%= hdAvailable %>"><br>
			</div>
			<div class="input-group">
			  <label>Watch on your </label>
			  <input type= "text" name="watchOnur" value="<%= watchOnur %>"> <br>
			</div>
			<div class="input-group">
			  <label>Unlimited movies or TV shows</label>
			  <input type= "text" name="moviesOrTvshow" value="<%= moviesOrTvshow %>"><br>
			</div>
			<div class="input-group">
			  <label>Screens you want watch on ate the same time</label>
			  <input type= "text" name="screens" value="<%= screens %>" ><br>
			</div>
			<div class="submit">
